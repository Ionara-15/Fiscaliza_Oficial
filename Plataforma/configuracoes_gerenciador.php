                        ...
                        <div class="col-lg-8 mx-auto">
                            ...
                            <div class="card shadow mb-4 border-bottom-info">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-white">
                                    <h6 class="m-0 font-weight-bold text-info"><i class="fas fa-headset mr-2"></i>Suporte e Contato</h6>
                                </div>
                                <div class="card-body text-center py-5">
                                    
                                    <div class="mb-4">
                                        <i class="fas fa-envelope-open-text fa-4x text-gray-300"></i>
                                    </div>
                                    
                                    <h5 class="font-weight-bold text-gray-800 mb-3">Como podemos ajudar?</h5>
                                    <p class="text-gray-600 mb-4 px-lg-5">
                                        Precisa de ajuda com a plataforma, encontrou algum erro ou tem alguma sugestão para melhorar o Fiscalize Aí? Nossa equipe está pronta para te atender!
                                    </p>
                                    
                                    <a href="mailto:plataforma.fiscaliza.ai@gmail.com?subject=Dúvida/Suporte%20-%20Plataforma%20Fiscalize%20Aí" class="btn btn-info btn-lg btn-icon-split shadow-sm">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-paper-plane"></i>
                                        </span>
                                        <span class="text">Enviar E-mail para a Equipe</span>
                                    </a>
                                    
                                    <p class="small text-muted mt-4 mb-0">Tempo máximo de resposta: 24 horas</p>
                                </div>
                            </div>
